export default function Footer() {
  return (
    <div className='flex flex-col md:flex-row w-full text-xs justify-evenly items-center font-thin'>
      <div className='flex items-center gap-2'>Made whit ❤️ by AlejandroD.</div>
